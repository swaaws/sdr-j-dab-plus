...
static const char qt_meta_stringdata_fib_processor[] = {
    "fib_processor\0\0,\0addEnsembleChar(char,int)\0"
    "addtoEnsemble(QString)\0nameofEnsemble(int,char*)\0"
    ",,,,,,\0technicalData(int,int,int,int,int,int,int)\0"
};
...
void fib_processor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->nameofEnsemble((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< char*(*)>(_a[2]))); break;
        case 3: _t->technicalData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4])),(*reinterpret_cast< int(*)>(_a[5])),(*reinterpret_cast< int(*)>(_a[6])),(*reinterpret_cast< int(*)>(_a[7]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 2
void fib_processor::nameofEnsemble(int _t1, char * _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 3
void fib_processor::technicalData(int _t1, int _t2, int _t3, int _t4, int _t5, int _t6, int _t7)
{
