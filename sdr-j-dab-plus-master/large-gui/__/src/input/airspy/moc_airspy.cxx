/****************************************************************************
** Meta object code from reading C++ file 'airspy.h'
**
...
#include "../../../../../src/input/airspy/airspy.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'airspy.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_airspyHandler[] = {
    "airspyHandler\0\0value\0set_lna_gain(int)\0"
    "set_mixer_gain(int)\0set_vga_gain(int)\0"
